...
- sp-002 — ТЗ `sp-002-seed-data-1a.md` и тестовый набор `sp-002-seed-data-1a-dataset.md` переведены в `approved`; engineer пишет план `sp-002-seed-data-1a-plan.md`.
